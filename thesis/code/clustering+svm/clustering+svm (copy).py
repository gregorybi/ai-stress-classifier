...
#plt.scatter(range(len(X_train_scaled)), X_train_scaled, c='black', label="Data points", edgecolors='k', s=50)
#plt.scatter(range(len(X_test_scaled)), X_test_scaled, marker='x', s=100, label="Test points")
